...
namespace AppArrange.WrapPanel
{
	/// <summary>
	/// Positions child elements sequentially from left to right or top to bottom. When elements
	/// extend beyond the panel edge, elements are positioned in the next row or column.
	/// </summary>
	/// <QualityBand>Mature</QualityBand>
	public class WrapPanel : Panel
	{
		/// <summary>
		/// A value indicating whether a dependency property change handler should ignore the next
		/// change notification. This is used to reset the value of properties without performing
		/// any of the actions in their change handlers.
		/// </summary>
		...
		/// </summary>
		/// <value>
		/// The identifier for the <see cref="P:WinRTXamlToolkit.Controls.WrapPanel.ItemHeight"/>
		/// dependency property
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The height applied to the layout area of each item that is contained within a <see
		/// cref="T:WinRTXamlToolkit.Controls.WrapPanel"/>. The default value is <see cref="F:System.Double.NaN"/>.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The identifier for the <see cref="P:WinRTXamlToolkit.Controls.WrapPanel.ItemWidth"/>
		/// dependency property.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// The width that applies to the layout area of each item that is contained in a <see
		/// cref="T:WinRTXamlToolkit.Controls.WrapPanel"/>. The default value is <see cref="F:System.Double.NaN"/>.
		/// </value>
		//[TypeConverter(typeof(LengthConverter))]
		...
		/// <summary>
		/// Identifies the <see cref="P:WinRTXamlToolkit.Controls.WrapPanel.Orientation"/>
		/// dependency property.
		/// </summary>
		/// <value>
		/// The identifier for the <see cref="P:WinRTXamlToolkit.Controls.WrapPanel.Orientation"/>
		/// dependency property.
		/// </value>
		// TODO: In WPF, WrapPanel uses AddOwner to register the Orientation property via
		// StackPanel. It then gets the default value of StackPanel's Orientation property. It looks
		// like this should be no different than using the same default value on a new Orientation property.
		...
		/// </summary>
		/// <value>
		/// One of the <see cref="T:Windows.UI.Xaml.Controls.Orientation"/> values. The default is
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:WinRTXamlToolkit.Controls.WrapPanel"/> class.
		/// </summary>
		public WrapPanel()
		{
		}
		...
		/// <summary>
		/// Arranges and sizes the <see cref="T:WinRTXamlToolkit.Controls.WrapPanel"/> control and
		/// its child elements.
		/// </summary>
		/// <param name="finalSize">
		/// The area within the parent that the <see cref="T:WinRTXamlToolkit.Controls.WrapPanel"/>
		/// should use arrange itself and its children.
		/// </param>
		/// <returns>The actual size used by the <see cref="T:WinRTXamlToolkit.Controls.WrapPanel"/>.</returns>
		protected override Size ArrangeOverride(Size finalSize)
		{
			// Variables tracking the size of the current line, and the maximum size available to
			// fill. Note that the line might represent a row or a column depending on the orientation.
			...
			// Measure each of the Children. We will process the elements one line at a time, just
			// like during measure, but we will wait until we've completed an entire line of
			// elements before arranging them. The lineStart and lineEnd variables track the size of
			// the currently arranged line.
		...
		/// <summary>
		/// Measures the child elements of a <see cref="T:WinRTXamlToolkit.Controls.WrapPanel"/> in
		/// anticipation of arranging them during the <see
		/// cref="Windows.UI.Xaml.FrameworkElement.ArrangeOverride(Windows.Foundation.Size)"/> pass.
		/// </summary>
		/// <param name="constraint">The size available to child elements of the wrap panel.</param>
		/// <returns>
		...
		{
			// Variables tracking the size of the current line, the total size measured so far, and
			// the maximum size available to fill. Note that the line might represent a row or a
		...
		/// </summary>
		/// <param name="d">WrapPanel that changed its ItemHeight or ItemWidth.</param>
		/// <param name="e">Event arguments.</param>
		[SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly", Justification = "Almost always set from the CLR property.")]
	...
	/// <summary>
	/// Numeric utility methods used by controls. These methods are similar in scope to the WPF
	/// DoubleUtil class.
	/// </summary>
	internal static class NumericExtensions
	{
		...
		/// <returns>True if the first number is close in value to the second, false otherwise.</returns>
		...
		public static bool IsNaN(this double value)
		{
			...
			// An IEEE 754 double precision floating point number is NaN if its exponent equals 2047
			// and it has a non-zero mantissa.
		...
		/// <summary>
		/// NanUnion is a C++ style type union used for efficiently converting a double into an
		/// unsigned long, whose bits can be easily manipulated.
		/// </summary>
