...
namespace BiliBili.UWP.Controls
{
	...
	{
		private BiliBili.JSBridge.biliapp _biliapp = new BiliBili.JSBridge.biliapp();
		private BiliBili.JSBridge.secure _secure = new BiliBili.JSBridge.secure();
		private Account account;
		private QRAuthInfo authInfo;

		private bool qr_loading = false;
