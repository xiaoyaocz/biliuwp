...
namespace BiliBili.UWP.Controls
{
	...
	public sealed partial class RepostDialog : ContentDialog
	{
		...
		private DynamicCardsModel _dynamicCardsModel;
		private bool _loadingAt = false;
		private int _userAtPage = 1;
		private List<AtDisplayModel> atDisplaylist = new List<AtDisplayModel>();
		private List<AtModel> atlist = new List<AtModel>();
		private Emote emote;
		private ObservableCollection<UploadImagesModel> imgs = new ObservableCollection<UploadImagesModel>();
		private bool isRepost = false;
		private ObservableCollection<EmotePackage> packages;
