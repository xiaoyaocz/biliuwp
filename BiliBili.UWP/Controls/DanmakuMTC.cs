...
namespace BiliBili.UWP.Controls
{
	...
	{
		// Using a DependencyProperty as the backing store for BrightnessProperty. This enables
		...
		// Using a DependencyProperty as the backing store for DanmakuProperty. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for GestureContent. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for MoreMenuFlyout. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for QuityContent. This enables animation,
		// styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowCoinsBtn. This enables animation,
		// styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowDanmakuBtn. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowDanmakuSettingBtn. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowNextButton. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowPlayListBtn. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowSendDanmaku. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowSendDanmuBtn. This enables
		// animation, styling, binding, etc...
		...
		// Using a DependencyProperty as the backing store for ShowShareBtn. This enables animation,
		// styling, binding, etc...
