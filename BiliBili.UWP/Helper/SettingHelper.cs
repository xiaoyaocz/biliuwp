...
namespace BiliBili.UWP
{
	public static class SettingHelper
	{
		...
		private static PackageId pack = (Package.Current).Id;
		...
		// secondaryTile.TileId = id; secondaryTile.DisplayName = name; secondaryTile.Arguments =
		// par; //secondaryTile. = square150x150Logo;

		// secondaryTile.VisualElements.ShowNameOnWide310x150Logo = true;
		// secondaryTile.VisualElements.ShowNameOnSquare150x150Logo = true;
		// secondaryTile.VisualElements.ForegroundText = ForegroundText.Light;
		// //secondaryTile.VisualElements.Square44x44Logo = new Uri(imgUrl,
		// UriKind.RelativeOrAbsolute); secondaryTile.VisualElements.Wide310x150Logo = new
		// Uri(imgUrl, UriKind.RelativeOrAbsolute); //secondaryTile.VisualElements.BackgroundColor =
		// co; //Windows.Foundation.Rect rect =(FrameworkElement)sender; //
