...
namespace BiliBili.UWP.Pages.Live
{
	...
	public sealed partial class LiveRoomPC : Page
	{
		...
		//自动领取瓜子
		private bool autoGetAward = false;

		private ObservableCollection<DanmuMsgModel> danmu_list;
		...
		//宝箱可领取时间
		private DateTime freeSilverTime;

		//宝箱Timer
		private DispatcherTimer freeSilverTimer;
		...
		//加载播放地址中
		private bool loadPlayurling = true;

		//打开弹幕
		private bool openDanmu = true;

		//轮播播放地址
		private List<Durl> playUrls;

		private bool receiveGiftMsg = true;

		private bool receiveSysMsg = true;

		private bool receiveWelcomeMsg = true;
