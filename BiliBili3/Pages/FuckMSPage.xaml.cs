...
namespace BiliBili3.Pages
{
    ...
    /// </summary>
    public sealed partial class FuckMSPage : Page
    {
        public FuckMSPage()
        {
        ...
        private void MTC_SendDanmakued(object sender, EventArgs e)
        {
        ...
        private void MTC_OnMiniWindows(object sender, EventArgs e)
        {

        }

        private void MTC_OnExitMiniWindows(object sender, EventArgs e)
        {
        ...
        private void MTC_CoinsEvent(object sender, EventArgs e)
        {
