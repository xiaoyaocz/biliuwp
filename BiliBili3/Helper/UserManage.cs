...
namespace BiliBili3.Helper
{
    static class UserManage
    {
        ...
        public static async Task<UserInfoModel> GetMyInfo()
        {
            ...
            {
                //
                string url = string.Format("http://app.bilibili.com/x/v2/space?access_key={0}&appkey={1}&platform=wp&ps=10&ts={2}000&vmid={3}&build=5250000&mobi_app=android", ApiHelper.access_key, ApiHelper._appKey_Android, ApiHelper.GetTimeSpan, Uid);
